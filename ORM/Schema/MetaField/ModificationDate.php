...
class ModificationDate extends AbstractMetaField implements MetaFieldInterface
{
    const DEFAULT_ATTR_NAME = '_modificationDate';
    ...
    {
        return $content->contentInfo->modificationDate;
    }
}