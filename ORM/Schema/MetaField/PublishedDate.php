...
class PublishedDate extends AbstractMetaField implements MetaFieldInterface
{
    const DEFAULT_ATTR_NAME = '_publishedDate';
    ...
    {
        return $content->contentInfo->publishedDate;
    }
}